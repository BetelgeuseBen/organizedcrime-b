...
-- Modified for smaller map size --
	MAX_DIPLO_DISTANCE = 100000,		-- 700					-- Most diplomacy is disallowed if two rulers are too distant
	MAX_DIPLO_DISTANCE_SAME_RELIGION = 0,						-- Bonus to max diplo distance for being of the same religion
	MAX_DIPLO_DISTANCE_SAME_RELIGION_GROUP = 0, 				-- Bonus to max diplo distance for being of the same religion group
	MAX_DIPLO_DISTANCE_SAME_CULTURE = 0, 						-- Bonus to max diplo distance for being of the same culture
	MAX_DIPLO_DISTANCE_SAME_CULTURE_GROUP = 0,				-- Bonus to max diplo distance for being of the same culture group
-----------------------------------
...
--------------------------------------
	IMPRISON_CHARACTER_INTERACTION_PIETY = -10,-- 10
--------------------------------------
...
--------------------------------
	PORTRAIT_OLD_AGE_THRESHOLD = 60,-- 50				-- Old age switch for character portraits
--------------------------------
	AGE_OF_ADULTHOOD_MALE = 16,						-- Male can rule at this age.
	AGE_OF_ADULTHOOD_FEMALE = 16,					-- Female can rule at this age.
--------------------------------
	AGE_OF_MARRIAGE_MALE = 18,	-- 16					-- Male allowed to marry at this age.
	AGE_OF_MARRIAGE_FEMALE = 18,-- 16					-- Female allowed to marry at this age.
--------------------------------
...
--------------------------------------
	TRIBAL_EMPTY_HOLDING_LEVY_MULTIPLIER = -0.15,
	TRIBAL_EMPTY_HOLDING_GARRISON_MULTIPLIER = -0.15,
	TRIBAL_EMPTY_HOLDING_TAX_MULTIPLIER = -0.15,
--------------------------------------	
...
------------------------------------
	MIN_COMBAT_DAYS = 1,		-- 8				-- Minimum number of days in combat
	NUMBER_OF_RETREAT_DAYS = 1,	-- 8				-- Number of days before you retreat successfully
------------------------------------
...
--------------------------------------------
	BATTLE_PRESTIGE_MULTIPLIER = 1000,	--10		-- Total prestige gained in the battle will be this * ( losers losses ) / 1000
--------------------------------------------
...
--------------------------------------------
	REINFORCE_RATE = 0.5,		-- 0.05				-- Reinforce rate per year
--------------------------------------------
...
--------------------------------------------
	ATTRITION_LEVEL_FACTOR = 0,				-- 0.5	-- A general "attrition per month" multiplier
	ATTRITION_LEVEL_FACTOR_50_OVER = 0,		-- 1.0	-- A general "attrition per month" multiplier when 50% over the supply limit
	ATTRITION_LEVEL_FACTOR_100_OVER = 0,	-- 2.0	-- A general "attrition per month" multiplier when 100% over the supply limit
--------------------------------------------
...
--------------------------------------------
	ARMY_MOVEMENT_SPEED = 30,		-- 3			-- Base movement speed of land units
--------------------------------------------
...
--------------------------------------------
	SUPPLY_CAPACITY = 365,					-- 31		-- Amount of days of worth supply that a unit can hold.
	OUT_OF_SUPPLY_ATTRITION_BASE = 0,		-- 0.001 	-- The attrition a unit that is out of supply takes.
	OUT_OF_SUPPLY_ATTRITION_INCREASE = 0,	-- 0.0001	-- The increase per tick of attrition a unit that is out of supply takes.
	OUT_OF_SUPPLY_ATTRITION_TICK = 365,		-- 1		-- The amount of days per tick for increase of attrition.
	FORAGING_PILLAGE_MODIFIER = 0,			-- 0.15		-- Modifies how much loot the army takes when re-supplying itself in enemy territory},
--------------------------------------------
	
	MONTHS_OF_UNDECIDED_WAR = 6,	-- 36		-- Number of months before a war can be won by an attacker unless a major battle is won
...
--------------------------------------------
	SHATTERED_RETREAT_HOSTILE_ATTRITION = 0,	-- 10	-- Attrition taken when traversing hostile territory durring a shattered retreat (as a percentage)
	SHATTERED_RETREAT_NEUTRAL_ATTRITION = 0,	-- 5	-- Attrition taken when traversing neutral territory durring a shattered retreat (as a percentage)
--------------------------------------------
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 1920,	--769	-- Set this to your earliest starting year
...
--------------------------------------------
	CITY_SPRAWL_AMOUNT = 0, -- 1 -- Size of cities, higher gives larger cities
--------------------------------------------
